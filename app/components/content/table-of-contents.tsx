  ...
  return (
    <Sheet>
      <SheetTrigger asChild>
        <Button variant="default" size="icon-lg" className="md:hidden fixed bottom-4 right-4">
          <Library className="h-6 w-6" />
          <span className="sr-only">Toggle table of contents</span>
        </Button>
      </SheetTrigger>
      <SheetContent side="bottom" className="h-[50vh]" aria-describedby={undefined}>
        <SheetHeader>
          <SheetTitle onClick={goToHeading} className="text-start" data-heading={title.text}>
            {title.text}
          </SheetTitle>
        </SheetHeader>
        <div className="py-4">
